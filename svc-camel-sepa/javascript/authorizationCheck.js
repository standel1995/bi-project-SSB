function checkAuthorization(exchange){
    ...
    priorityAmount = Number(priorityAmount);
    logger.info("checkAuthorization: typeof priorityAmount = " + priorityAmount);
    ...
    if(!channelIdKey) {
        channelIdKey = PLCN_sourcechannelId;
    }
    ...
    authConfigAmount = memTblGetTableValue(map, "AMOUNT_CAP_TBL_MAP", authKey); //10000000
    logger.info("checkAuthorization: authConfigAmount = " + authConfigAmount); 
    authConfigAmount = Number(authConfigAmount);
    logger.info("checkAuthorization: typeof authConfigAmount = " + authConfigAmount);
